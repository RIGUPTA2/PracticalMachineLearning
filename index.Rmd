...
```{r}
setwd("C:/Users/IBM_ADMIN/Desktop/LocalRepository/DataScience/8_PracticalMachineLearning/")
...
if (!file.exists('data/pml-training.csv')) {
  download.file(trainingURL, 'data/pml-training.csv', 'curl')
}

if (!file.exists('data/pml-testing.csv')) {
  download.file(trainingURL, 'data/pml-testing.csv', 'curl')
}
